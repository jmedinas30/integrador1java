...
(1837, 'MATO', 19),
(1838, 'PAMPAROMAS', 19),
(1839, 'PUEBLO LIBRE', 19),
(1840, 'SANTA CRUZ', 19),
(1841, 'SANTO TORIBIO', 19),
(1842, 'YURACMARCA', 19),
(1843, 'BAGUA', 2),
(1844, 'ALEXANDER VON HUMBOLDT', 192),
(1845, 'NESHUYA', 192);
...
CREATE TABLE `notificacion` (
  ...
  `id_cliente` int(11) NOT NULL,
  `id_mascota` int(11) NOT NULL,
  `id_programacion_vacuna` int(11) DEFAULT NULL,
...
CREATE TABLE `prescripcion_medica` (
  `id_prescripcion_medica` int(11) NOT NULL,
...
--
-- Estructura de tabla para la tabla `programacion_vacunas`
--

CREATE TABLE `programacion_vacunas` (
  `id_programacion_vacuna` int(11) NOT NULL,
  `id_mascota` int(11) NOT NULL,
...
ALTER TABLE `notificacion`
  ...
  ADD KEY `id_cliente` (`id_cliente`),
  ADD KEY `id_mascota` (`id_mascota`),
  ADD KEY `id_programacion_vacuna` (`id_programacion_vacuna`),
...
ALTER TABLE `prescripcion_medica`
  ADD PRIMARY KEY (`id_prescripcion_medica`),
  ADD KEY `id_historial` (`id_historial`);

--
-- Indices de la tabla `programacion_vacunas`
--
ALTER TABLE `programacion_vacunas`
  ADD PRIMARY KEY (`id_programacion_vacuna`),
  ADD KEY `id_mascota` (`id_mascota`),
...
--
-- AUTO_INCREMENT de la tabla `detalle_historial_medico`
--
ALTER TABLE `detalle_historial_medico`
...
--
ALTER TABLE `distrito`
  MODIFY `id_distrito` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1846;
...
--
ALTER TABLE `prescripcion_medica`
  MODIFY `id_prescripcion_medica` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `programacion_vacunas`
--
ALTER TABLE `programacion_vacunas`
  MODIFY `id_programacion_vacuna` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT de la tabla `provincia`
--
ALTER TABLE `provincia`
  MODIFY `id_provincia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=195;
...
ALTER TABLE `cita`
  ...
  ADD CONSTRAINT `cita_ibfk_2` FOREIGN KEY (`id_veterinario`) REFERENCES `personal` (`id_personal`);

--
-- Filtros para la tabla `cliente`
--
ALTER TABLE `cliente`
  ADD CONSTRAINT `cliente_ibfk_1` FOREIGN KEY (`id_departamento`) REFERENCES `departamento` (`id_departamento`),
  ADD CONSTRAINT `cliente_ibfk_2` FOREIGN KEY (`id_provincia`) REFERENCES `provincia` (`id_provincia`),
  ADD CONSTRAINT `cliente_ibfk_3` FOREIGN KEY (`id_distrito`) REFERENCES `distrito` (`id_distrito`);

--
-- Filtros para la tabla `control_acceso`
--
ALTER TABLE `control_acceso`
  ADD CONSTRAINT `control_acceso_ibfk_1` FOREIGN KEY (`ID_personal`) REFERENCES `personal` (`id_personal`);

--
-- Filtros para la tabla `detalle_historial_medico`
--
ALTER TABLE `detalle_historial_medico`
  ADD CONSTRAINT `detalle_historial_medico_ibfk_1` FOREIGN KEY (`id_historial`) REFERENCES `historial_medico` (`id_historial`),
  ADD CONSTRAINT `detalle_historial_medico_ibfk_2` FOREIGN KEY (`id_tratamiento`) REFERENCES `tratamiento` (`id_tratamiento`);
...
--
ALTER TABLE `historial_medico`
  ADD CONSTRAINT `historial_medico_ibfk_1` FOREIGN KEY (`id_mascota`) REFERENCES `mascota` (`id_mascota`);

--
-- Filtros para la tabla `licencia`
--
ALTER TABLE `licencia`
  ADD CONSTRAINT `licencia_ibfk_1` FOREIGN KEY (`ID_personal`) REFERENCES `personal` (`id_personal`);

--
-- Filtros para la tabla `mascota`
--
ALTER TABLE `mascota`
  ADD CONSTRAINT `mascota_ibfk_1` FOREIGN KEY (`id_cliente`) REFERENCES `cliente` (`id_cliente`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `mascota_ibfk_2` FOREIGN KEY (`id_especie`) REFERENCES `especie` (`id_especie`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `notificacion`
  ...
  ADD CONSTRAINT `notificacion_ibfk_2` FOREIGN KEY (`id_mascota`) REFERENCES `mascota` (`id_mascota`),
  ADD CONSTRAINT `notificacion_ibfk_3` FOREIGN KEY (`id_programacion_vacuna`) REFERENCES `programacion_vacunas` (`id_programacion_vacuna`),
  ADD CONSTRAINT `notificacion_ibfk_4` FOREIGN KEY (`id_cita`) REFERENCES `cita` (`id_cita`);

--
-- Filtros para la tabla `personal`
--
ALTER TABLE `personal`
  ADD CONSTRAINT `personal_ibfk_1` FOREIGN KEY (`id_distrito`) REFERENCES `distrito` (`id_distrito`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `personal_ibfk_2` FOREIGN KEY (`id_provincia`) REFERENCES `provincia` (`id_provincia`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `personal_ibfk_3` FOREIGN KEY (`id_departamento`) REFERENCES `departamento` (`id_departamento`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `prescripcion_medica`
--
ALTER TABLE `prescripcion_medica`
  ADD CONSTRAINT `prescripcion_medica_ibfk_1` FOREIGN KEY (`id_historial`) REFERENCES `historial_medico` (`id_historial`);

--
-- Filtros para la tabla `programacion_vacunas`
--
ALTER TABLE `programacion_vacunas`
  ADD CONSTRAINT `programacion_vacunas_ibfk_1` FOREIGN KEY (`id_mascota`) REFERENCES `mascota` (`id_mascota`),
  ADD CONSTRAINT `programacion_vacunas_ibfk_2` FOREIGN KEY (`id_vacuna`) REFERENCES `vacunas` (`id_vacuna`);
