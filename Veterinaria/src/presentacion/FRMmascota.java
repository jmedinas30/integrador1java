...
public class FRMmascota extends javax.swing.JInternalFrame {
  ...
  DAOdistrito di = new DAOdistrito();
   ...
   public void setValorTextBox(String valor1, String valor2 ) {
    txtcliente.setText(valor1);
    lblcodigo.setText(valor2);
    
}
   
    public void setValorTextBox2(String valor3, String valor4 ) {
    txtraza.setText(valor3);
    lblcodraza.setText(valor4);
  ...
  for (mascota x : obj.listado()) {
    ...
    private void initComponents() {
        ...
        setClosable(true);
        setTitle("Ficha de registro de mascotas");
        ...
        btnadd1.setText("Guardar Cambios");
