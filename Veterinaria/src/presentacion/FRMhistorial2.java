...
import controlador.DAOhistorial_medico;
 ...
 * @author Esteban
 */
public class FRMhistorial2 extends javax.swing.JInternalFrame {
  ...
  DAOdistrito di = new DAOdistrito();
   ...
   DAOcliente obj2 = new DAOcliente();
    ...
    DAOhistorial_medico obj10 = new DAOhistorial_medico();
   private String dato;
...
lbledad.setText(resultado);
    ...
    private void btnadd1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnadd1ActionPerformed
      historial_medico cli = new historial_medico();
      cli.setDiagnostico(txtdiagnostico.getText());
